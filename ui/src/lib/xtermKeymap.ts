// Terminal key-sequence helpers — copied verbatim from Terax
// (github.com/crynta/terax-ai, src/modules/terminal/lib/keymap.ts, Apache-2.0).
// See NOTICE. Framework-agnostic; consumed by Terminal.tsx's
